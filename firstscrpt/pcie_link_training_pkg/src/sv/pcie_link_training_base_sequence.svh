...
// File    pcie_link_training_base_sequence.svh

class pcie_link_training_base_sequence extends uvm_sequence;
  ...
  rand int unsigned weight[pcie_link_training_state_t][pcie_link_training_state_t] = '{default:initial_edge_weight}; //< constrainable weights for each possible edge. Initial value set to 'initial_edge_weight'

  
  // ----------------------------------------------
  // Coverage
  // ----------------------------------------------
  protected pcie_link_training_state_t current_state;
  protected pcie_link_training_state_t previous_state;
  pcie_link_training_cg cg;
  extern virtual           function int          get_custom_coverage();
  
  // ----------------------------------------------
  // GoTo & Edge Management
  // ----------------------------------------------
  protected pcie_link_training_state_t goto_next_state; // where to go
  protected pcie_link_training_state_t goto_from_state; // where from
  protected int unsigned goto_saved_weight[pcie_link_training_state_t]; // saved weight of the source before going
  ...
  extern virtual           function void exclude_next(pcie_link_training_state_t next);
  extern virtual           function void include_next(pcie_link_training_state_t next,int unsigned _weight=initial_edge_weight);
  extern virtual           function void exclude_edge(pcie_link_training_state_t src,dst);
  extern virtual           function void include_edge(pcie_link_training_state_t src,dst,int unsigned _weight=initial_edge_weight);
  extern virtual           function int unsigned get_current_iteration();
  extern virtual           function pcie_link_training_state_t get_current_state();
  extern virtual           function pcie_link_training_state_t get_previous_state();
  
  // ----------------------------------------------
  /// Constructor
  // ----------------------------------------------
  extern function          new(string name="pcie_link_training_base_sequence");
  ...
  extern virtual protected function void         update_transition(pcie_link_training_state_t _src, _dst);
  ...
  `uvm_object_utils_begin(pcie_link_training_base_sequence)
...
endclass : pcie_link_training_base_sequence
