// SVGraph my_fsm
// File    my_fsm_base_sequence.svh

class my_fsm_base_sequence extends uvm_sequence;
  ...
  protected bit          randomization_done = 0;   ///< Randomization done flag
  ...
  rand int unsigned weight[my_fsm_state_t][my_fsm_state_t]; //< constrainable weights for each possible edge. Initial value set to 'initial_edge_weight'

  
  // ----------------------------------------------
  // Coverage
  // ----------------------------------------------
  protected my_fsm_state_t current_state;
  protected my_fsm_state_t previous_state;
  my_fsm_cg cg;
  ...
  // ----------------------------------------------
  protected my_fsm_state_t goto_next_state; // where to go
  protected my_fsm_state_t goto_from_state; // where from
  protected int unsigned goto_saved_weight[my_fsm_state_t]; // saved weight of the source before going
  ...
  extern virtual           function void include_next(my_fsm_state_t next,int unsigned _weight=initial_edge_weight);
  extern virtual           function void exclude_edge(my_fsm_state_t src,dst);
  extern virtual           function void include_edge(my_fsm_state_t src,dst,int unsigned _weight=initial_edge_weight);
  extern virtual           function int unsigned get_current_iteration();
  extern virtual           function my_fsm_state_t get_current_state();
  extern virtual           function my_fsm_state_t get_previous_state();
  
  // ----------------------------------------------
  /// Constructor
  // ----------------------------------------------
  extern function          new(string name="my_fsm_base_sequence");
  ...
  extern virtual protected function void         update_transition(my_fsm_state_t _src, _dst);
  ...
  `uvm_object_utils_begin(my_fsm_base_sequence)
